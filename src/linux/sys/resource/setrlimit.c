...
/* XXX: there are two options for setting limits in the kernel:
 ...
 *   - setrlimit(): pointer-sized fields; for 32-bit binaries, these values
...
syscall_choice(
    ...
    /* option    */ PRLIMIT64, __setrlimit_via_prlimit64,
#endif
#ifdef __NR_setrlimit
    /* option    */ SETRLIMIT, __sys_setrlimit,
#endif
)
