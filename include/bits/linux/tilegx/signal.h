...
#ifndef _LINUX_TILEGX_SIGNAL_H
#define _LINUX_TILEGX_SIGNAL_H _LINUX_TILEGX_SIGNAL_H
...
// XXX: per kernel headers, this was "used in earlier Tilera releases"?
