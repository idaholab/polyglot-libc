...
#ifndef _LINUX_X86_64_SIGNAL_H
#define _LINUX_X86_64_SIGNAL_H _LINUX_X86_64_SIGNAL_H
...
/* XXX: this is defined in <bits/linux/x86_64/syscall.h>, but we don't want to
 * include that here to prevent cyclic includes */
void __sys_rt_sigreturn();

#define SA_RESTORER 0x04000000u
#define __kernel_sa_rt_restorer __sys_rt_sigreturn
...
/* XXX: simplified definitions in case we need them from assembly-land */
#define SIG_DFL         0
#define SIG_ERR         -1
#define SIG_IGN         1
