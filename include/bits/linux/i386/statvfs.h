...
#ifndef _LINUX_I386_STATVFS_H
#define _LINUX_I386_STATVFS_H _LINUX_I386_STATVFS_H

#include <stdint.h> // FIXME: this should probably be kernel types
